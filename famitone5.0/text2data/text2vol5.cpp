// text2vol5.cpp  version 5.2, Oct 8, 2025
// doug fraker 2016-2025, adding volume column, with values 70-7f
...
// changes by slembcke, for Dn-Famitracker compatibility
...
int output_header(char *songname, int song)
{
	...
	fprintf(outfile, ";edited by Doug Fraker, 2025, to add volume column, all notes, \n"); // **
...
int main(int argc, char *argv[])
{
	...
	if (text_find_tag("FamiTracker text export", 0) >= 0) // removed hash
	{
